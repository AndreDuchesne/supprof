...
/* @var $searchModel app\models\TblpostesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Tblpostes');
    ...
    $(\'#BtnDelete\').click(function(){
        ...
        if(choix==1){
            var HotId = $(\'#w0\').yiiGridView(\'getSelectedRows\');
              $.ajax({
                type: \'POST\',
                url : \'index.php?r=tblpostes/multiple-delete\',
                data : {row_id: HotId},
                success : function() {
    ...
    <p>
        ...
        echo GridView::widget([
            ...
            [
                ...
                'urlCreator' => function ($action, Tblpostes $model, $key, $index, $column) {
                    return Url::toRoute([$action, 'id' => $model->idtblpostes]);
                 }
            ],            
