...
/* @var $searchModel app\models\TblmessagesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Tblmessages');
    ...
    $(\'#BtnDelete\').click(function(){
        ...
        if(choix==1){
            var HotId = $(\'#w0\').yiiGridView(\'getSelectedRows\');
              $.ajax({
                type: \'POST\',
                url : \'index.php?r=tblmessages/multiple-delete\',
                data : {row_id: HotId},
                success : function() {
        ...
        echo GridView::widget([
            ...
            'columns'=>[
                        ...
                        [
                            ...
                            'urlCreator' => function ($action, Tblmessages $model, $key, $index, $column) {
